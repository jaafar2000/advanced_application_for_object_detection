...
def nbhan1():
    os.system('camruler.py')



   
b2 = Button(root2,borderwidth = 20,highlightthickness = 20,command =nbhan,relief = "flat",bg='blue',text="Object Detection")
b2.place(x =600, y =300,width = 200,height = 90)
b3 = Button(root2,borderwidth = 20,highlightthickness = 20,command =nbhan1,relief = "flat",bg='green',text="Check Dimension")
b3.place(x =600, y =400,width = 200,height = 90)
b4 = Button(root2,borderwidth = 20,highlightthickness = 20,command =root2.destroy,relief = "flat",bg='red',text="EXIT")
b4.place(x =600, y =500,width = 200,height = 90)
